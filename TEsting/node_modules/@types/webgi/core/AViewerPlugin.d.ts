...
import { PartialPick, SimpleEventDispatcher } from 'ts-browser-helpers';
import { IFilter, IPass, IPassID, IShaderPropertiesUpdater, IViewerApp, IViewerPlugin } from 'webgi/interfaces';
