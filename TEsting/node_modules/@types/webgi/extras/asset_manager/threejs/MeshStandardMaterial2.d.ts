import { BufferGeometry, Camera, Color, Event, IUniform, Material, MeshPhysicalMaterial, MeshPhysicalMaterialParameters, Object3D, Scene, Shader, Vector2, WebGLRenderer } from 'three';
...
export declare class MeshStandardMaterial2 extends MeshPhysicalMaterial<Event, 'beforeCompile' | 'materialUpdate' | 'beforeRender' | 'afterRender'> implements IMaterial {
