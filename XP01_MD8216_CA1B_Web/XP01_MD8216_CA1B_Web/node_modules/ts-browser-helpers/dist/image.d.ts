 ...
 * @category Images
 */
export declare function imageBitmapToCanvas(bitmap: ImageBitmap | CanvasImageSource, maxWidth?: number, detachBitmap?: boolean): HTMLCanvasElement;
/**
 ...
 * @category Images
 */
export declare function imageBitmapToBase64(bitmap: ImageBitmap | CanvasImageSource, maxWidth?: number, detachBitmap?: boolean, type?: string): string;
/**
 ...
 * @category Images
 */
export declare function imageBitmapToBlob(bitmap: ImageBitmap | CanvasImageSource, maxWidth?: number, detachBitmap?: boolean, type?: string): Promise<Blob>;
/**
