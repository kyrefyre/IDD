...
(function (global, factory) {
        ...
        static Deserialize(data, obj, meta, isThis = false) {
            ...
            if (data && typeof data === 'object' && (data.constructor || Object) !== Object && !Array.isArray(data) && !data.serializableClassId) {
                if (data instanceof Blob)
                    return data; // todo special check for Blob/File
     ...
     */
    class FnCaller {
        static callFunction(fn, obj, params = []) {
            if (!obj)
                return fn(...params);
            if (fn.name && obj[fn.name] === fn)
            ...
            if (!FnCaller.methodMap.has(obj))
                FnCaller.methodMap.set(obj, new WeakMap());
            const methods = FnCaller.methodMap.get(obj);
            if (!methods.has(fn)) {
                let p = obj;
                while (p) {
                    const descp = Object.values(Object.getOwnPropertyDescriptors(p));
    ...
    FnCaller.methodMap = new WeakMap();
            ...
            const prop = {
                ...
                set(newVal) {
                    ...
                    if (typeof fnKey === 'string')
                        ...
                        FnCaller.callFunction(fnKey, this, params);
                },
            };
...
<svg viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
    ...
    exports.cloneScriptTag = cloneScriptTag;
    ...
    exports.imageBitmapToBlob = imageBitmapToBlob;
    exports.imageBitmapToCanvas = imageBitmapToCanvas;
    ...
    exports.objectMap2 = objectMap2;
    exports.onChange = onChange;
    exports.onChange2 = onChange2;
    exports.onChange3 = onChange3;
    exports.onChangeDispatchEvent = onChangeDispatchEvent;
    ...
    exports.safeReplaceString = safeReplaceString;
    exports.safeSetProperty = safeSetProperty;
    exports.serializable = serializable;
    exports.serialize = serialize;
    exports.setInnerHTMLWithScripts = setInnerHTMLWithScripts;
    ...
    exports.wrapThisFunction = wrapThisFunction;
    exports.wrapThisFunction2 = wrapThisFunction2;
