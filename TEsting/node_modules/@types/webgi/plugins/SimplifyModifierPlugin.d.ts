...
import { IGeometry, IModel } from 'webgi/interfaces';
 ...
 */
export declare abstract class SimplifyModifierPlugin extends AViewerPlugin<''> {
    ...
    simplifyGeometries(geometry?: ValOrArr<IGeometry>, options?: SimplifyOptions): any[] | undefined;
    ...
    simplifyAll(root?: IModel, options?: SimplifyOptions): Promise<any[] | undefined>;
